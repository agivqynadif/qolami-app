...
class PelajaranHurufViewModel:ViewModel() {
    ...
    val listDataPelajaranDetail = arrayListOf(
        ...
        DataPelajaranHurufDetail("Pelajaran 5", R.drawable.img_fathahtain, "Pelajaran 5", "Huruf Berharakat Fathatain", "Pelajari penggunaan harakat Fathahtain pada kata, frasa, dan konsep tata bahasab"),
